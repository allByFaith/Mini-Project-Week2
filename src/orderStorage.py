...
def writeOrder(inName, inAddress, inPhone, inSTATUS):
    ...
    myOrderList = [{'customer_name':inName, 'customer_address':inAddress, 'customer_phone':inPhone, 'status':inSTATUS}]
...
def updateOrder(inAction):
    ...
    try:
        ...
        if (inAction == 'd'):
            ...
            currentOrderList[orderIndex][inStatus] = selectSTATUS
        ...
        with open(orderFile, 'w') as csvFile:
             ...
             print(f"Index[{orderIndex}] is deleted")
